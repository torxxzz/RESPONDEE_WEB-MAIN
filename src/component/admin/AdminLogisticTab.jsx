...
import styles from "./AdminLogisticTab.module.css";
import {
  Search,
  Calendar,
  ChevronDown,
...
function LogisticTab() {
  ...
  return (
    <section className={styles.logisticContainer}>
    {!selectedLogistic ? (
      <div className={styles.logisticBody}>
        {/* 🔸 Sub Sidebar */}
        ...
        <div className={styles.logisticColumn}>
          ...
          <div className={styles.logisticList}>
            {filteredLogistics.map((log) => (
              <div
                key={log.id}
                className={`${styles.logisticItem} ${log.unread ? styles.unreadLogistic : ""}`}
              ...
              >
                ...
                <div className={styles.logisticDetails}>
      ...
      <div className={styles.logisticDetailExpanded}>
